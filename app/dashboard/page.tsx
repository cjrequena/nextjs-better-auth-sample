...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4">
      ...
      {/* ── Layer 2 Examples: RequirePermission ──────────────── */}
      <div className="card bg-base-200 shadow-lg mb-6">
        <div className="card-body">
          ...
          <RequirePermission
            ...
            fallback={<p className="text-sm opacity-50 italic">🔒 appointments:read — not granted</p>}
          >
            <div className="alert alert-success mb-2">
              <span>✅ You can view appointments (appointments:read)</span>
            </div>
          </RequirePermission>

          <RequirePermission
            permission="appointments:write"
            fallback={<p className="text-sm opacity-50 italic">🔒 appointments:write — not granted</p>}
          >
            <div className="alert alert-success mb-2">
              <span>✅ You can create/edit appointments (appointments:write)</span>
            </div>
          </RequirePermission>

          <RequirePermission
            permission="billing:write"
            fallback={<p className="text-sm opacity-50 italic">🔒 billing:write — not granted</p>}
          >
            <div className="alert alert-success mb-2">
              <span>✅ You can manage billing (billing:write)</span>
            </div>
          </RequirePermission>
      ...
      <div className="card bg-base-200 shadow-lg mb-6">
        <div className="card-body">
          ...
          >
            <div className="alert alert-info mb-2">
              <span>🩺 My Schedule — view and manage your appointments</span>
            </div>
          </RequireRole>
          ...
          {jwtToken && (
            <>
              <div className="mb-3">
                ...
                <pre className="text-xs overflow-auto p-3 bg-base-300 rounded-lg max-h-32 break-all whitespace-pre-wrap">
                  {jwtToken}
                </pre>
              </div>
